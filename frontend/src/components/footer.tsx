const Footer = () => {
	return (
		<footer className="mt-4 border-t border-white/10 bg-[#0A1A2F]/60 backdrop-blur-md">
			<div className="mx-auto p-4">
				<div className="flex justify-between">
					<div className="font-semibold text-lg">Docwalrus</div>
					<div className="flex items-center gap-6">
						<a
							href="https://x.com/docwalrus"
							target="_blank"
						...
						<a
							href="https://discord.gg/docwalrus"
							target="_blank"
							rel="noopener noreferrer"
							className="text-faint hover:text-white transition-colors"
						>
				...
				<div className="mt-2 border-t border-white/10 pt-4 text-center text-xs text-faint">
